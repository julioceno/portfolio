  ...
  return (
    <div className="bg-main-white dark:bg-dark-main-black h-screen px-10">
      ...
      <main className="mt-20 flex flex-col items-center gap-10 md:grid grid-cols-2 ">
        ...
        />
        <p className="text-center md:text-left text-md text-main-black dark:text-main-white leading-6 font-poppins drop-shadow-lg  md:mt-[-6rem] lg:mt-[-10rem] md:w-8/12">
