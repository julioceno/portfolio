...
function LandingPage() {
  return (
    <div className="bg-main-white dark:bg-dark-main-black h-screen px-10 xl:px-48 ">
      <Header />
      <main className="mt-20 flex flex-col items-center gap-10 md:grid grid-cols-2 ">
        <div className="flex flex-col items-center md:items-start gap-3 grid-col-2">
          <h1 className="text-4xl lg:text-6xl text-main-black dark:text-main-white font-medium text-center md:text-left font-poppins">
            Desenvolvedor de <br />
